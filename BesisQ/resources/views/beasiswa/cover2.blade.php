...
<script type="text/javascript" src="{{asset('ckeditor/ckeditor.js')}}"></script>
          <div class="form-group">
            <label class="col-md-1 control-label" for="inputDefault">Nama Beasiswa</label>
            <div class="col-md-5">
          ...
          <div class="form-group">
            <label class="col-md-1 control-label">Fakultas</label>
            <div class="col-md-4">
          ...
          <div class="form-group">
            <label class="col-md-1 control-label" for="inputDefault">Right Text</label>
            <div class="col-md-11">
              <textarea class="ckeditor" id="ckedtor" name="right_text"></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-1 control-label" for="inputDefault">Middle Text</label>
            <div class="col-md-11">
